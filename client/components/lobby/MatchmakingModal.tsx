...
function MatchmakingModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4 backdrop-blur-md animate-in fade-in duration-200">
      <div className="relative w-full max-w-md overflow-hidden rounded-3xl border border-[var(--surface-border)] bg-[var(--surface-card)] p-8 text-center shadow-2xl">
        ...
        <div className="relative mx-auto flex size-36 items-center justify-center">
          ...
          <div className="flex size-24 items-center justify-center rounded-full border border-[var(--primary-border)] bg-primary-gradient/10 text-3xl shadow-inner">
            <Crown className="size-10 animate-bounce text-[var(--primary)]" />
          </div>
        </div>
        ...
        <div className="mt-6 space-y-1.5">
          ...
          <p className="pt-2 font-mono text-xl font-bold text-[var(--primary)]">
